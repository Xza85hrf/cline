...
export const deepseekModels = {
	"deepseek-chat": {
		...
		inputPrice: 0.5,
		outputPrice: 1.5,
		description: "DeepSeek Chat is a powerful conversational AI model optimized for chat applications and general purpose tasks."
	},
	"deepseek-coder": {
		name: "deepseek-coder",
		provider: "deepseek",
		...
		inputPrice: 0.5,
		outputPrice: 1.5,
		description: "DeepSeek Coder is specialized for code generation and understanding, with enhanced capabilities for programming tasks."
	}
} as const satisfies Record<string, ModelInfo>
